...
# File copied from openml-python but overwritten logic to find the cache directory
...
class TestBase(unittest.TestCase):
    ...
    def setUp(self, tmpdir_suffix: str = "") -> None:
        ...
        * increases the maximal number of retries
        ...
        # cache
        self.maxDiff = None
        static_cache_dir = Path(__file__).parent.absolute() / "files"
